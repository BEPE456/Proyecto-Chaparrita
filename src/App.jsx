...
function App() {
  ...
  let random = [{
    id: 1,
    description: "Vamos gatita di si por favor",
    img: "https://i.pinimg.com/originals/db/aa/c1/dbaac13f6278b91a15e480752b8a7242.gif"
  },
  {
    id: 1,
    description: "Piénsalo de nuevo mi chanchita.",
  ...
  {
    id: 3,
    description: "No tengas miedo, será genial mi miopita.",
    img: "https://i.pinimg.com/originals/e1/c3/88/e1c388133e0f998e25bb17c837b74a14.gif"
  },
  {
    id: 4,
    description: "Confía en mí, será divertido mi gordita bella.",
  ...
  {
    id: 6,
    description: "Te prometo que será inolvidable, aunque seas bien Dory.",
    ...
    <main id="canvas" className="fondo w-screen h-screen bg-no-repeat bg-cover flex items-center justify-center bg-center ">
      {
        !valueSi ? (
          <div className="p-5">
            <h1 className="text-white font-bold text-5xl text-center">¿Hola Chaparrita, Quieres ser mi San Valentin?</h1>
          ...
          <div className="flex justify-center items-center flex-col space-y-10">
            <h1 className="text-4xl text-white font-bold">Sabia que dirias que si chaparrita ❤️!</h1>
